    ...
    <div className="flex-container">
      <div className="navbar">
        <div
          ...
          style={menuToggle === true ? { opacity: "0.16" } : { opacity: "1" }}
        >
          <img src={main} />
        </div>
        ...
        <div className="navbar_main">
          <div className="navbar_menu_button">
            <button>
              <img src={toggleMenu} onClick={() => setMenuToggle(true)} />
            </button>
          </div>
          <div
            id="mySidenav"
            className="sidenav"
            style={menuToggle === true ? { width: "300px" } : { width: "0px" }}
          >
        ...
        >
          <div className="top_center_content">
            <div className="text_head center_width">
              <h1>Brunch</h1>
              <h2>FULL WEBSITE</h2>
